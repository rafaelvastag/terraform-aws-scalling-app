...
resource "aws_subnet" "this" {
  ...
  for_each = {
    "pub_a" = ["192.168.1.0/24", "${var.aws_region}a", "pub_a"]
    "pub_b" = ["192.168.2.0/24", "${var.aws_region}b", "pub_b"]
    "pvt_a" = ["192.168.3.0/24", "${var.aws_region}a", "pvt_a"]
    "pvt_b" = ["192.168.4.0/24", "${var.aws_region}b", "pvt_b"]
  }
